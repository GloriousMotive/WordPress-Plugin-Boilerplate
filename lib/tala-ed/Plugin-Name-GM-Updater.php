...
class PLUGIN_NAME_GM_Updater {
	...
	public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
		 ...
		 */
		do_action( 'post_plugin_name_gm_updater_setup', $edd_plugin_data );
	 ...
	 *
	 * @see PLUGIN_NAME_GM_Updater::request_recently_failed
	 *
	 * @since 1.9.1
	 */
	...
	private function get_version_from_remote() {
		 ...
		 */
		$api_params = apply_filters( 'plugin_name_gm_updater_api_params', $api_params, $this->api_data, $this->plugin_file );
